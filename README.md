...
- **Chess:** [chess.js](https://github.com/jhlywa/chess.js) (rules, FEN, moves); [Stockfish](https://stockfishchess.org/) WASM (engine)
...
- **Play vs AI:** White vs Stockfish; Casual or Serious difficulty. Game auto-saves.
...
- **Stockfish** — The app is designed to use [Stockfish](https://stockfishchess.org/) (GPL-3.0) as the AI engine. This repository ships a **placeholder** worker (`src/engine/stockfish-worker.js`) that does not include Stockfish code. The MIT license above applies only to EvenChess; any Stockfish WASM you integrate is used under GPL-3.0, and distribution of a build that includes Stockfish must comply with GPL-3.0 for that component (attribution, license text, source offer).
